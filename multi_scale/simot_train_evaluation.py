...
def createModel():
    ...
    model3 = Lambda(grayInverse)(input0)
    model3 = Conv2D(18, (5, 5), activation='relu')(model3)
    model3 = MaxPooling2D(pool_size =(3, 3))(model3)
    model3 = Conv2D(36, (4, 4), padding='same', activation='relu')(model3)
    model3 = Conv2D(36, (4, 4), padding='same', activation='relu')(model3)
    ...
    out = Dense(96, activation='relu')(conc)
