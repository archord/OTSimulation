...
def createModel_32_2():
    
    keras.backend.set_image_dim_ordering('th')
    
    input0 = Input(shape=(3, 64, 64))
    
    model1 = Cropping2D(cropping=16,data_format='channels_first')(input0) #32*32
    model1 = Conv2D(18, (5, 5), padding='same', activation='relu')(model1)
    model1 = Conv2D(18, (5, 5), padding='same', activation='relu')(model1)
    model1 = MaxPooling2D(pool_size =(2, 2))(model1)
    model1 = Conv2D(36, (2, 2), padding='same', activation='relu')(model1)
...
def createModel_16_32_60():
    ...
    model3 = Cropping2D(cropping=16,data_format='channels_first')(input0) #32*32
    model3 = MaxPooling2D(pool_size =(2, 2))(model3)
    model3 = Conv2D(18, (5, 5), padding='same', activation='relu')(model3)
    model3 = Conv2D(18, (5, 5), padding='same', activation='relu')(model3)
    model3 = MaxPooling2D(pool_size =(2, 2))(model3)
    model3 = Conv2D(36, (3, 3), padding='same', activation='relu')(model3)
    model3 = Conv2D(36, (3, 3), padding='same', activation='relu')(model3)
    model3 = MaxPooling2D(pool_size =(2, 2))(model3)
    model3 = Conv2D(48, (2, 2), padding='same', activation='relu')(model3)
    model3 = Conv2D(48, (2, 2), padding='same', activation='relu')(model3)
    model3 = MaxPooling2D(pool_size =(2, 2))(model3)
    model3 = Conv2D(64, (2, 2), padding='same', activation='relu')(model3)
    model3 = Conv2D(64, (2, 2), padding='same', activation='relu')(model3)
    ...
    model2 = Cropping2D(cropping=2,data_format='channels_first')(input0) #60*60
    model2 = MaxPooling2D(pool_size =(3, 3))(model2)
    model2 = Conv2D(18, (5, 5), padding='same', activation='relu')(model2)
    model2 = Conv2D(18, (5, 5), padding='same', activation='relu')(model2)
    model2 = MaxPooling2D(pool_size =(2, 2))(model2)
    model2 = Conv2D(36, (3, 3), padding='same', activation='relu')(model2)
    model2 = Conv2D(36, (3, 3), padding='same', activation='relu')(model2)
    model2 = MaxPooling2D(pool_size =(2, 2))(model2)
    model2 = Conv2D(48, (2, 2), padding='same', activation='relu')(model2)
    model2 = Conv2D(48, (2, 2), padding='same', activation='relu')(model2)
    model2 = MaxPooling2D(pool_size =(2, 2))(model2)
    model2 = Conv2D(64, (2, 2), padding='same', activation='relu')(model2)
    model2 = Conv2D(64, (2, 2), padding='same', activation='relu')(model2)
    model2 = MaxPooling2D(pool_size =(2, 2))(model2)
    model2 = Flatten()(model2)
...
def createModel_08_16_32():
    ...
    model2 = Cropping2D(cropping=28,data_format='channels_first')(input0) #8*8
...
def createModel_08_16_32_60_2():
    ...
    model4 = Cropping2D(cropping=2,data_format='channels_first')(input0) #60*60
    model4 = MaxPooling2D(pool_size =(3, 3))(model4)
    model4 = Conv2D(18, (5, 5), padding='same', activation='relu')(model4)
    model4 = Conv2D(18, (5, 5), padding='same', activation='relu')(model4)
    model4 = MaxPooling2D(pool_size =(2, 2))(model4)
    model4 = Conv2D(36, (3, 3), padding='same', activation='relu')(model4)
    model4 = Conv2D(36, (3, 3), padding='same', activation='relu')(model4)
    model4 = MaxPooling2D(pool_size =(2, 2))(model4)
    model4 = Conv2D(48, (2, 2), padding='same', activation='relu')(model4)
    model4 = Conv2D(48, (2, 2), padding='same', activation='relu')(model4)
    model4 = MaxPooling2D(pool_size =(2, 2))(model4)
    model4 = Conv2D(64, (2, 2), padding='same', activation='relu')(model4)
    model4 = Conv2D(64, (2, 2), padding='same', activation='relu')(model4)
