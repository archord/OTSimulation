...
def test():
    ...
    tpath1 = 'data'
    tpath2 = 'data'
    tiCat = 'G041_mon_objt_190101T20584991_s800_zoom3.cat'
    oiCat = 'G041_mon_objt_190101T22274991_s800_zoom3.cat'
    oiFit = 'G041_mon_objt_190101T22274991_s800_zoom3.fit'
    
    #doAll(tiPath, tiFile, oiPath, oiFile, oiImgPath, oiImgFile, savePath, origImgName, templateImgName)
    doAll(tpath1, tiCat, tpath1, oiCat, tpath1, oiFit, tpath2, oiCat, oiCat)
